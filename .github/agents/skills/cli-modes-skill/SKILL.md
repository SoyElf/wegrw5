...
description: "Advanced guide to GitHub Copilot CLI mode orchestration, decision frameworks, safe execution patterns, and real-world workflow sequences for task delegation and execution"
keywords:
  - cli-modes
  - orchestration
  - delegation-patterns
...
# CLI Modes & Orchestration: Comprehensive Agent Skill
...
- **You're designing multi-step workflows** and want proven orchestration patterns
- **You need to understand safety guardrails** and approval gates
- **You're optimizing for cost/speed** and want model selection heuristics
- **You're debugging a failed task** and need recovery strategies
- **You're a specialist agent** interpreting mode hints from orchestrators

**Skip this skill if**:
- You're writing code (use language-specific skills instead)
- You're debugging runtime errors (use troubleshooting skill instead)
- You just need a quick answer (use c-ask instead of reading full guide)

## How Agents Use This Skill

### For Orchestrators (@ben)
Reference this skill to:
- Choose appropriate CLI modes when delegating tasks
- Communicate task complexity to specialist agents using mode hints
- Understand safety boundaries and approval requirements
- Design multi-step workflows that leverage different modes
...
- Optimize task execution for cost and latency

### For Power Users & Builders
Reference this skill to:
- Automate complex tasks using CLI modes effectively
- Understand when to escalate from reading (c-ask) to planning (c-plan) to execution
- Leverage safety guardrails to prevent mistakes
- Troubleshoot issues with mode interactions
...
- [**agent-customization**](copilot-skill:/agent-customization/SKILL.md) — Create, update, and debug VS Code agent customization files
- **hindsight-docs** — Complete documentation for Hindsight memory and learning systems
- **find-skills** — Discover and install agent skills matching your needs
...
**Word Count**: ~9,200 words (comprehensive guide)
**Author**: Multi-agent research & documentation synthesis

---

**End of CLI Modes & Orchestration Skill**
