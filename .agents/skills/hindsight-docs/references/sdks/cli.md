...
The Hindsight CLI provides command-line access to memory operations and bank management. All commands follow the [OpenAPI specification](<../../../../../../assets/openapi.json>), so you can use `--help` on any command to see all available options.
